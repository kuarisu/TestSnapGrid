...
public class UI_ScaleDropDownBool : MonoBehaviour {
    ...
    public void ChangeEnable()
    {
        ...
        {
            case 0:
                m_Variable.text = "true";
                break;
            case 1:
                m_Variable.text = "false";
                break;
        }
        this.transform.root.GetComponent<OperateurOperande>().ChangeOpBool();
    }
